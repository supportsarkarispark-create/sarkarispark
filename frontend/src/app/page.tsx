...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950 font-sans selection:bg-indigo-500 selection:text-white">
      <Navbar />
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-slate-900 border border-indigo-200/40 dark:border-slate-800 rounded-3xl overflow-hidden shadow-2xl shadow-indigo-500/10">
        <div
          className="relative h-[360px] sm:h-[420px] cursor-pointer"
        ...
        >
          ...
          <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-950/70 border border-white/20 backdrop-blur-md text-[11px] sm:text-xs font-bold text-amber-300 shadow-md">
              <Sparkles className="h-3.5 w-3.5 text-amber-400" />
              {currentSlide?.badge || "🔥 Featured Test Series"}
            </span>
            <span className="px-2.5 py-1 rounded-full bg-slate-950/70 border border-white/20 backdrop-blur-md text-[11px] font-semibold text-white/90 shadow-md">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 space-y-2">
            {currentSlide?.title && (
              <h3 className="text-white text-xl sm:text-2xl font-black tracking-tight leading-snug drop-shadow-md">
                {currentSlide.title}
              </h3>
            )}
            {currentSlide?.subtitle && (
              <p className="text-slate-200/90 text-xs sm:text-sm font-normal line-clamp-2 max-w-xl drop-shadow">
                {currentSlide.subtitle}
              </p>
            )}
            ...
            <div className="pt-2 flex items-center gap-3">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 text-slate-950 font-bold text-xs sm:text-sm shadow-lg shadow-amber-500/25 group-hover:scale-105 transition-transform">
